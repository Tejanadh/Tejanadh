...
**Smart Contract Security Researcher | EVM + Solana**

B.Tech Computer Science student (Graduating 2028) focused on finding high-impact vulnerabilities in blockchain protocols and low-level systems.

[Twitter](https://x.com/TEJANadh10) • [LinkedIn](https://linkedin.com/in/teja-nadh-2919062b4) • tejanadh927@gmail.com
...
- **Tools:** Foundry, Anchor, Hardhat, solana-test-validator, Echidna, GDB, Valgrind
- **Focus Areas:** Cross-chain security, oracle manipulation, gas accounting, slashing mechanics, memory safety in protocol clients

---

## About

Independent security researcher with 2+ years of experience finding vulnerabilities in DeFi and infrastructure protocols. I build deterministic mainnet-fork PoCs and have disclosed multiple high/critical issues across Solana and Ethereum ecosystems.
